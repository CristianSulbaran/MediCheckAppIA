...
Proyecto construido con **React (TypeScript)** y **Tailwind CSS**, desplegado en **Azure Static Web Apps**. Incluye un algoritmo de aprendizaje automatico **Random Forest**.
